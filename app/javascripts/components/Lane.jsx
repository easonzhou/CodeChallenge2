...
export default class Lane extends React.Component {
  constructor() {
    ...
    this.handleSortLane = this.handleSortLane.bind(this);
  }
        ...
        <div className="lane">
          <h2 className="lane__name">
            ...
            <p className="lane__count">
              {laneNotes.length} Projects
            </p>
            <button
              className="lane__sort"
              onClick={this.handleSortLane}
            />
            <button
